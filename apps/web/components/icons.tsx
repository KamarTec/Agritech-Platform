...
function Base({ children, className = 'w-5 h-5', ...props }: IconProps & { children: ReactNode }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export const StethoscopeIcon = (p: IconProps) => (
  <Base {...p}>
    ...
    <path d="M8 15a6 6 0 0 0 6 6 4 4 0 0 0 4-4v-4" />
...
export const ImageIcon = (p: IconProps) => (
  <Base {...p}>
    ...
    <path d="m21 15-4.34-4.34a2 2 0 0 0-2.83 0L7 17" />
  </Base>
)
